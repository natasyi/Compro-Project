            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                <form method="POST" action="{{ route('admin.principles.update', $principle) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{ Storage::url($principle->thumbnail) }}" alt="Thumbnail" class="rounded-2xl object-cover w-[90px] h-[90px]">
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{ Storage::url($principle->icon) }}" alt="Icon" class="rounded-2xl object-cover w-[90px] h-[90px]">
