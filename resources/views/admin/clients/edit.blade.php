                ...
                <form method="POST" action="{{ route('admin.clients.update', $client) }}" enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="occupation" class="block mt-1 w-full" type="text" name="occupation"
                            value="{{ old('occupation', $client->occupation) }}" required autofocus autocomplete="occupation" />
                    ...
                    <div class="mt-4">
                        ...
                        @if ($client->avatar)
                            <img src="{{ Storage::url($client->avatar) }}" alt="Avatar" class="rounded-2xl object-cover w-[90px] h-[90px]">
                        @endif
                    ...
                    <div class="mt-4">
                        ...
                        @if ($client->logo)
                            <img src="{{ Storage::url($client->logo) }}" alt="Logo" class="rounded-2xl object-cover w-[90px] h-[90px]">
                        @endif
